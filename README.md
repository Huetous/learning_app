...
***Note: further, the term "function" should be understood as a function graph, the term "task" should be understood as a test task (for example, " pick a pair for graph")
